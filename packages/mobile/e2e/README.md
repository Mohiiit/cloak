...
| 06 | `CUfLL` | Send (keyboard) | `packages/mobile/src/screens/SendScreen.tsx`, `packages/mobile/src/components/KeyboardSafeContainer.tsx` | pending | `packages/mobile/e2e/screenshots/2026-02-17/06-CUfLL-ios.png` | pending | n/a | passed |
