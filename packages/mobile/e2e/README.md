...
| 08 | `UhCeU` | Wallet (shield keyboard) | `packages/mobile/src/screens/WalletScreen.tsx` | pending | `packages/mobile/e2e/screenshots/2026-02-17/08-UhCeU-ios.png` | pending | n/a | passed |
