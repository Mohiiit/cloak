...
| 07 | `O3kob` | Wallet (default) | `packages/mobile/src/screens/WalletScreen.tsx`, `packages/mobile/src/testing/testIDs.ts` | pending | `packages/mobile/e2e/screenshots/2026-02-17/07-O3kob-ios.png` | pending | n/a | passed |
