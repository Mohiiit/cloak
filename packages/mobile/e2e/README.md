...
| 04 | `Sap4z` | Ward Dashboard (frozen) | `packages/mobile/src/screens/HomeScreen.tsx`, `packages/mobile/src/navigation/AppNavigator.tsx` | pending | `packages/mobile/e2e/screenshots/2026-02-17/04-Sap4z-ios.png` | pending | n/a | passed |
